...
<template>
    <form class="flex gap-4" @submit.prevent="submit">
        <input
            class="text-zinc-50 block w-full p-4 pl-10 text-sm border border-gray-300 rounded-lg bg-gray-50
        ...
        <button
            class="text-center p-4 text-sm font-medium text-white bg-green-700 rounded-lg border border-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Get
            Pokemon</button>
