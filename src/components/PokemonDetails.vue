                ...
                <div class="text-sm font-medium text-gray-900 dark:text-white">
                    ...
                    <div v-if="toggleEncounterDetail" class="grid grid-cols-3 gap-4">
                        <div v-if="encounterLocations?.length">
                            <PokemonEncounterLocations @click="location = encounterLocation.location_area.name"
                                v-for="encounterLocation in encounterLocations" :key="encounterLocation.location_area.name"
